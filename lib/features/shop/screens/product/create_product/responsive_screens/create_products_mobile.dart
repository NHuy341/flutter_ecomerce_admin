...
class CreateProductsMobileScreen extends StatefulWidget {
  const CreateProductsMobileScreen({super.key});

  @override
  State<CreateProductsMobileScreen> createState() =>
      _CreateProductsMobileScreenState();
}

class _CreateProductsMobileScreenState
    extends State<CreateProductsMobileScreen> {
